...
export default function FinanceAdmin() {
  ...
  return (
    <div className="space-y-5">
      ...
      {showAdd && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 animate-modal-overlay"
          style={{ backgroundColor: 'rgba(0,0,0,0.4)' }}>
          <div className="w-full max-w-md rounded-2xl p-5 space-y-4 animate-modal-body" style={{ backgroundColor: 'var(--bg-card)' }}>
            <div className="flex items-center justify-between">
